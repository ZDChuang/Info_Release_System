	...
	<table align="center" width="80%" border="1" cellpadding="0"
		...
		<tr>
			...
			<s:iterator value="hotNews">
				<li>
				<a href="hotNews.jsp?content=<s:property value="content"/>"><s:property value="head"/></a>
				</li>
			</s:iterator>
				</ol></td>
			<td><ol>
			<s:iterator value="fileNews">
				<li>
				<a href="fileNews.jsp?content=<s:property value="content"/>"><s:property value="head"/></a>
				</li>
			</s:iterator>
				</ol></td>
		</tr>
		...
		<tr>
			<td height="150"><ol>
				...
				<li>
				<a href="confNews.jsp?content=<s:property value="content"/>"><s:property value="head"/></a>
				</li>
			</s:iterator>
				</ol></td>
			<td><ol>
