	...
	<form action="updateNews" method="post">
		<table width="80%" height="170" border="1" cellpadding="0"
			...
			<tr>
				...
				<td width="560"><input name="head" value="<%=request.getParameter("head")%>" type="text" size="100%"></td>
			</tr>
			<tr>
				<td height="73"><strong>ÐÅÏ¢ÄÚÈÝ</strong></td>
				<td><p>
						<textarea name="content" cols="100%" rows="30"><%=request.getParameter("content")%></textarea>
					</p></td>
			</tr>
			<tr>
